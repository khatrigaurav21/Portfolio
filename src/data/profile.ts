export const hero = {
  eyebrow: 'Open to Project Management & Business Analyst roles',
  name: 'Gaurav Khatri',
...
export const education = [
  { degree: 'MBA (Finance)', institution: 'Sikkim Manipal University', year: '2013' },
  { degree: 'Master of Commerce (Business Administration)', institution: 'Rajasthan University', year: '2012' },
  { degree: 'Bachelor of Commerce', institution: 'Rajasthan University', year: '2009' }
];
...
export const contact = {
  hook: 'Got a broken process? I probably have opinions.',
  email: 'khatri.gaurav@outlook.com',
  phone: '+61 420 339 500',
  linkedin: 'https://www.linkedin.com/in/kha3gaurav'
};
